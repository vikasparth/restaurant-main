...
const ReservationPage = () => {
  ...
  return (
    <div className="container max-w-lg py-12">
      <h1 className="text-center font-serif text-4xl font-bold text-foreground">Make a Reservation</h1>
      <p className="mt-2 text-center text-muted-foreground">Book your table and enjoy an authentic Indian dining experience</p>
      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-5">
        ...
        <div>
          ...
          <select value={guests} onChange={(e) => setGuests(e.target.value)} className="w-full rounded-md border border-input bg-background px-3 py-2.5 text-sm">
        ...
        <div>
          ...
          <input type="tel" value={phone} onChange={(e) => setPhone(e.target.value)} className="w-full rounded-md border border-input bg-background px-3 py-2.5 text-sm" placeholder="Your phone number" required />
        </div>
