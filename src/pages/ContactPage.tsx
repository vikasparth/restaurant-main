      ...
      <div className="mx-auto mt-10 grid max-w-4xl gap-10 md:grid-cols-2">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="mt-4 flex gap-4">
              <a
                ...
                style={{ backgroundColor: "hsl(220, 46%, 48%)" }}
                aria-label="Facebook"
              >
                <svg
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              For quick responses to order inquiries, reservations, catering questions, and general
              support.
            </p>
            <WhatsAppButton
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full rounded-md bg-primary py-2.5 text-sm font-semibold text-primary-foreground hover:opacity-90 transition-colors"
            >
              Send Message
            </button>
          </form>
