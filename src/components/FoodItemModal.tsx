    ...
    <>
      ...
      >
        ...
        >
          <button
            onClick={onClose}
            className="absolute right-3 top-3 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-background/80 hover:bg-secondary"
            aria-label="Close"
          >
            <X className="h-4 w-4" />
          </button>
          ...
          <div className="p-6">
            ...
            <div className="mt-6 flex items-center gap-4">
              <div className="flex items-center gap-3 rounded-md border border-border px-2">
                ...
                <button onClick={() => setQty(qty + 1)} className="p-1 hover:text-primary">
